  ...
  return (
    <div>
      <section className="max-sm:h-[24.5rem] md:h-[40rem] relative">
        <div><Image  className='absolute w-full max-sm:h-[20.5rem] md:h-[40rem]  -top-24 -z-10' src={ban} alt='banner'/>
        <div style={{background: "linear-gradient(90deg, rgba(0, 0, 0, 0) 0%, #000000 108.28%);"}} className='z-0 w-full max-sm:h-[20.5rem] md:h-[40rem] absolute opacity-90 -top-24'></div>
        ...
        <div className="lg:w-[993px] relative max-sm:-bottom-10 h-[441px] max-sm:w-[17.5rem] max-sm:h-[8.8rem] max-sm:px-3  md:py-10 px-12 max-sm:m-[1rem] sm:m-[4rem] rounded-[24px] bg-black bg-opacity-[50%] text-white">
      ...
      <div className='max-sm:-mt-20 -mt-10'>
    <Services/>
